# 3C System — Requirements & Agent Brief
...
Build a production-quality 3C (Camera, Character, Control) system on top of the ZPC
...
| Frame budget (3C update) | ≤ 2 ms @ 60 FPS | Benchmark |
...
- **Namespace:** `zs::` for framework extensions, `zs::threeC::` for domain types (TBD)
