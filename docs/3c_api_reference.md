# ZPC 3C API Reference

Complete API reference for the ZPC 3C (Camera, Character, Control) system.
...
| Namespace | Contents |
|-----------|----------|
| `zs::threeC` | All 3C domain types, camera modes, character state, input, pipeline |
...
|--------|-------|---------|
| `zpc_3c_core` | `zpcbase` | Core.hpp, MathExtensions.hpp, Telemetry.hpp |
| `zpc_3c_input` | `zpc_3c_core` | InputTypes.hpp, AxisProcessor.hpp, ActionMap.hpp, InputBuffer.hpp |
| `zpc_3c_camera` | `zpc_3c_core` | Camera.hpp, MatrixBuilders.hpp, Frustum.hpp, CameraMode.hpp, CameraShake.hpp, CameraRig.hpp |
| `zpc_3c_character` | `zpc_3c_core`, `zpc_3c_input` | CharacterState.hpp |
| `zpc_3c_integration` | `zpc_3c_camera`, `zpc_3c_character`, `zpc_3c_input` | ThreeCPipeline.hpp |

---

## Core Types

**Header:** `zensim/3c/Core.hpp`
...
**Header:** `zensim/3c/MathExtensions.hpp`  
**Namespace:** `zs::`
...
**Header:** `zensim/3c/input/InputTypes.hpp`
...
**Header:** `zensim/3c/input/AxisProcessor.hpp`
...
**Header:** `zensim/3c/input/ActionMap.hpp`
...
**Header:** `zensim/3c/input/InputBuffer.hpp`
...
**Header:** `zensim/3c/camera/Camera.hpp`
...
**Header:** `zensim/3c/camera/MatrixBuilders.hpp`
...
**Header:** `zensim/3c/camera/Frustum.hpp`
...
**Header:** `zensim/3c/camera/CameraMode.hpp`
...
**Header:** `zensim/3c/camera/CameraShake.hpp`
...
**Header:** `zensim/3c/camera/CameraRig.hpp`
...
**Header:** `zensim/3c/character/CharacterState.hpp`
...
**Header:** `zensim/3c/ThreeCPipeline.hpp`
...
Top-level entry point for the 3C system.

```cpp
struct ThreeCPipeline {
...
**Header:** `zensim/3c/Telemetry.hpp`
