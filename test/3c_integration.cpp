/// @file 3c_integration.cpp
/// @brief Integration tests for Phase 5: FpsMode, CameraShake, CameraRig,
///        ThreeCPipeline, mode transitions, and full pipeline wiring.
...
// ═══════════════════════════════════════════════════════════════════════
//  Test 5: ThreeCPipeline full frame
// ═══════════════════════════════════════════════════════════════════════
...
int main() {
  fprintf(stderr, "=== 3C Integration Tests ===\n");
  ...
  if (failures == 0) {
    fprintf(stderr, "\n=== ALL 3C INTEGRATION TESTS PASSED ===\n");
  } else {
    fprintf(stderr, "\n=== %d TEST(S) FAILED ===\n", failures);
  }
  return failures;
