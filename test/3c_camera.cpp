...
#include "zensim/3c/camera/Frustum.hpp"
...
static bool vec3_eq(zs::threeC::Vec3f a, zs::threeC::Vec3f b, float eps = 1e-4f) {
  return near_eq(a(0), b(0), eps) && near_eq(a(1), b(1), eps) && near_eq(a(2), b(2), eps);
}

static float dot3(zs::threeC::Vec3f a, zs::threeC::Vec3f b) {
  return a(0) * b(0) + a(1) * b(1) + a(2) * b(2);
}

static float len3(zs::threeC::Vec3f v) {
