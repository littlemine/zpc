...
function(zpc_target_reflect_sources target)
  ...
  # Create an empty placeholder so target_sources() does not fail at configure
  # time. The real content is generated by zpc_reflect_tool at build time.
  if(NOT EXISTS "${_reflect_gen_src}")
    file(WRITE "${_reflect_gen_src}" "// placeholder -- generated by zpc_reflect_tool at build time\n")
  endif()
