...
cmake --build "%BUILD_DIR%" --target validationschema validationformat validationcompare
if errorlevel 1 exit /b %errorlevel%

ctest --test-dir "%BUILD_DIR%" -R "ZsValidationSchema|ZsValidationFormat|ZsValidationCompare" --output-on-failure
exit /b %errorlevel%