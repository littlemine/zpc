#pragma once
/// @file Telemetry.hpp
/// @brief Per-frame telemetry types for 3C system performance and quality tracking.
///
...
namespace zs::threeC {
  ...
  ///   "3c.total_phase_ms"          → totalPhaseMs        (≤ 2.0)
  ///   "3c.input_phase_ms"          → inputPhaseMs        (≤ 0.2)
  ///   "3c.character_phase_ms"      → characterPhaseMs    (≤ 0.5)
  ///   "3c.camera_phase_ms"         → cameraPhaseMs       (≤ 0.5)
  ///   "3c.input_latency_ms"        → inputToScreenLatencyMs (≤ 16.67)
  ///   "3c.camera_jitter_px_rms"    → cameraJitterPx      (≤ 0.5)
