#pragma once
/// @file ThreeCPipeline.hpp
/// @brief Full-frame 3C pipeline: INPUT -> CHARACTER -> CAMERA -> TELEMETRY.
///
/// ThreeCPipeline wires together the input, character, and camera subsystems
...
/// and FrameTelemetry.
///
/// This is the top-level entry point for the 3C system.  It owns a
...
namespace zs::threeC {
  ...
  /// Complete output of one frame of the 3C pipeline.
  ...
  /// The top-level 3C frame pipeline.
  ///
  /// Owns:
  ...
  struct ThreeCPipeline {
    ...
    /// Run one complete frame of the 3C pipeline.
    ///
