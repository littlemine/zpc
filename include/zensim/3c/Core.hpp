#pragma once
/// @file Core.hpp
/// @brief 3C system core types — shared aliases, FrameContext, constants.
///
/// This header is the root dependency for all 3C modules. It provides
...
namespace zs::threeC {
  ...
  /// Per-frame timing and sequencing information, passed to every 3C update phase.
  struct FrameContext {
